      ...
      <div className="bg-white ackdrop-filter backdrop-blur-lg bg-opacity-30 border-b firefox:bg-opacity-90 border-gray-200 px-2 sm:px-4 py-4 rounded dark:bg-black dark:ackdrop-filter dark:backdrop-blur-lg dark:bg-opacity-30 dark:border-b fdark:irefox:bg-opacity-90 dark:border-gray-700">
        <div className="container flex flex-wrap justify-between items-center mx-auto">
          ...
          <div className="flex md:order-2">
            ...
            <div className={isOpen ? "showMenuNav bg-white dark:bg-gray-900" : "hideMenuNav"}>
              <div
              ...
              <ul className="flex flex-col items-center justify-between min-h-[250px]">
                <li className="text-transparent bg-clip-text text-base font-semibold
                  bg-gradient-to-r from-rose-400 via-fuchsia-500 to-indigo-500 my-8 uppercase text-gray-700 hover:bg-gray-50 border-b border-gray-300 md:border-b md:border-gray-300 md:text-transparent md:bg-clip-text 
